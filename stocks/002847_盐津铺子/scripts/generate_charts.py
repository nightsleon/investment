#!/usr/bin/env python3
"""Generate Salted Shop quarterly price vs profit charts from Tonghuashun XLS."""
...
CHARTS = BASE / "charts"
DATA = BASE / "data"
XLS = DATA / "002847_main_simple.xls"
CODE = "002847"
COMPANY = "盐津铺子"
...
def fetch_price() -> pd.DataFrame:
    raw = yf.download("002847.SZ", start="2017-01-01", auto_adjust=False, progress=False)
