#!/usr/bin/env python3
"""Generate Proya quarterly price vs profit charts from Tonghuashun single-quarter XLS."""
...
CHARTS = BASE / "charts"
DATA = BASE / "data"
XLS = DATA / "603605_main_simple.xls"
CODE = "603605"
COMPANY = "珀莱雅"
...
def fetch_price() -> pd.DataFrame:
    raw = yf.download("603605.SS", start="2017-01-01", auto_adjust=False, progress=False)
