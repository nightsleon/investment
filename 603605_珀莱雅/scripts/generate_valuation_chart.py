#!/usr/bin/env python3
"""Generate Proya ten-year PE valuation chart."""
...
ax.set_title("珀莱雅：近十年PE(TTM)区间", fontproperties=FONT, fontsize=17, weight="bold", pad=18)
...
path = OUT / "603605_5.2_近十年PE区间图.png"
